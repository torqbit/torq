...
const GetStarted: FC<{ user: User }> = ({ user }) => {
  return (
    <section className={styles.get__started}>
      <div>
        <h3>Get Started with Torqbit today</h3>
        <p>
          No matter you are a complete beginner or a seasoned professional, this training platform is for anyone who
          wants to build and ship great software products.
        </p>
